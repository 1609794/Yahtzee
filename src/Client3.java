...
//add code to get client to wait if output = not the same round
        while (true) {
  		    ...
  		    //Add loop for 13 rounds TOOK OUT FOR LOOP	    
  		   if(round < 14) {
...
//  	    	fromServer = in.readLine();
            ...
            //find a way to modify client so that instead of typing score in to send to server it just takes in the currentScore value variable
            
            System.out.println(ActionClientID + " sending to ActionServer");
