...
//		        	System.out.println("It's 3K");
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Initialised " + ActionClientID + " client and IO connections");
          ...
          int round = 1;
//add code to get client to wait if output = not the same round
        while (true) {
  	...
  	//	    	//See what we have rolled
  		  ...
  		  while(round >= 13) { 
             ...
             fromServer = in.readLine();
  			  ...
  			  System.out.println("You have finished the game! Press Enter and wait for results");
            	fromUser = stdIn.readLine();
            	out.println("Game Over");
            	fromServer = in.readLine();
            	System.out.println(fromServer + " From Server");
            	if(fromServer.contains("Player")) {
            		System.out.println("Press quit to exit game...");
            		fromUser = stdIn.readLine();
            		out.println("quit");
            		fromServer = in.readLine();
            		System.out.println(fromServer + " from Server");
            ...
            while(fromServer.equalsIgnoreCase("not the same round")) {
            	System.out.println("You are ahead. Press Enter and wait");
            	fromUser = stdIn.readLine();
            	out.println(currentScore);
            	fromServer = in.readLine();
            }
            System.out.println(ActionClientID + " received " + fromServer + " from Server");
            round++; 
        }
